...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // htmlcoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
        ...
        int rand = generateMTRandom(seed, 1000000000);
...
static const int64 nTargetSpacing = 2; 
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // htmlcoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal htmlcoin miner
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // htmlcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
